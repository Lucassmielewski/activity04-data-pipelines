...
**Response**: The message = FALSE option makes is so the R console output log does not show up in the Rmd file.  
...
**Response**: All you would need to do is sort the variable unemployment rate in a ascending order. 
...
**Response**: There are only 10 stem majors with a median salary less than $36,000 and most of them are in the science field. 
